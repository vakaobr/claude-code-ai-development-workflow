...
"Your device just told everyone nearby every network name it remembers - that alone can map where you live, work, and travel."
...
open network still learns a lot about *who* and *what* you connect to - and everything for non-HTTPS traffic."
...
3. **Disable auto-join** for open networks and **"forget" old ones** -    stops silent reconnection and quiets your probe requests.
